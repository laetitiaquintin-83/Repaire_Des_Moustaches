        ...
        <div class="step-list" style="margin-top: 25px; display: flex; flex-direction: column; gap: 20px;">
            <div class="step-item" style="display: flex; gap: 15px; align-items: flex-start;">
                ...
                <div class="step-content">
                    ...
                    <p style="margin: 0;">Plutôt que de choisir un animal derrière des grilles, venez passer un moment avec lui autour d'un café. Réservez l'un de nos ateliers pour voir si le courant passe naturellement entre vous !</p>
                </div>
            </div>
